...
identificador = Agent(
    role="Identificar os Problemas",
    goal="identificar de qual área é o seguinte problema: {problema}",
    backstory="Você está trabalhando na identificação de um problema de telecomunicações"
              "sobre o problema: {problema}."
              "Você coleta informações através de sites e arquivos que ajudam a "
